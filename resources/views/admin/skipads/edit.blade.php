    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Skip Ads Update</h4>
        ...
        <div class="panel-body">
            <form action="{{ route('skipads.update',$data->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="form-group">
                            ...
                            <input type="text" name="ads_link" id="" class="form-control" value="{{ $data->ads_link }}">
