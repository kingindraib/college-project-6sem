                ...
                <table id="data-table-default"
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{  Str::limit($data->question,20) }} </td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('faq.delete',$data->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('are you sure ?')"><i class="fa fa-trash"></i></a>
