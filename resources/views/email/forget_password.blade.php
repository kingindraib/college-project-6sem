...
<body>
    <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
        <div style="margin:50px auto;width:70%;padding:20px 0">
            ...
            <p>Thank you for choosing {{ $settings->site_title }}. Use the following OTP to complete your Forget Password procedures. OTP is
                valid for 5 minutes. Never Share Your OTP others</p>
            <h2
